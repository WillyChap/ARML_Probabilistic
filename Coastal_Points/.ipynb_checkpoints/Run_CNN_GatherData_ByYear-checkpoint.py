...
df_out.to_pickle(newdir+'NN_CRPS_CNNPP'+'_StartingYear'+str(2018-years_back)+'_ref2.pkl')
np.savez(newdir+'NN_CRPS_CNNPP'+'_StartingYear'+str(2018-years_back)+'_ref2.npz',lat=lat,lon=lon,IVTgefsm=mAl,IVTgefss=sAl,IVTm_gefs=yAl)
...
df_out = pd.DataFrame({'time':tout,'OBS':yAl,'Model':wwrfAl,'IVTmean':mAl,'IVTstd':sAl,'lat':latoutAl,'lon':lonoutAl})
df_out.to_pickle(newdir+'NN_CRPS_CNNPP'+'_StartingYear'+str(2018-years_back)+'_FINETUNEref2.pkl')
np.savez(newdir+'NN_CRPS_CNNPP'+'_StartingYear'+str(2018-years_back)+'_FINETUNEref2.npz',lat=lat,lon=lon,IVTgefsm=mAl,IVTgefss=sAl,IVTm_gefs=yAl)
...
print(newdir+'NN_CRPS_CNNPP'+'_StartingYear'+str(2018-years_back)+'_FINETUNEref2.pkl')
print(newdir+'NN_CRPS_CNNPP'+'_StartingYear'+str(2018-years_back)+'_FINETUNEref2.pkl')
print(newdir+'NN_CRPS_CNNPP'+'_StartingYear'+str(2018-years_back)+'_FINETUNEref2.pkl')
print(newdir+'NN_CRPS_CNNPP'+'_StartingYear'+str(2018-years_back)+'_FINETUNEref2.pkl')
print(newdir+'NN_CRPS_CNNPP'+'_StartingYear'+str(2018-years_back)+'_FINETUNEref2.pkl')

...
for ddfa, bb in enumerate(range(len(res)-3,len(res))):
    ...
    newdir = '/glade/scratch/wchapman/Reforecast/models/NN_CRPS/' +fcast+'/StartingYear'+str(2018-years_back)+'/NNft_'+tstyr
...
df_out.to_pickle(newdir+'NN_CRPS_NNPP'+'_StartingYear'+str(2018-years_back)+'_FINETUNEref2.pkl')
np.savez(newdir+'NN_CRPS_NNPP'+'_StartingYear'+str(2018-years_back)+'_FINETUNEref2.pkl',lat=lat,lon=lon,IVTgefsm=mAl,IVTgefss=sAl,IVTm_gefs=yAl)
...
print(newdir+'NN_CRPS_NNPP'+'_StartingYear'+str(2018-years_back)+'_FINETUNEref2.pkl')
print(newdir+'NN_CRPS_NNPP'+'_StartingYear'+str(2018-years_back)+'_FINETUNEref2.pkl')
print(newdir+'NN_CRPS_NNPP'+'_StartingYear'+str(2018-years_back)+'_FINETUNEref2.pkl')
print(newdir+'NN_CRPS_NNPP'+'_StartingYear'+str(2018-years_back)+'_FINETUNEref2.pkl')
print(newdir+'NN_CRPS_NNPP'+'_StartingYear'+str(2018-years_back)+'_FINETUNEref2.pkl')
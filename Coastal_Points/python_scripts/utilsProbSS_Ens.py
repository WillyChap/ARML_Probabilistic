...
exampfil = "/glade/scratch/wchapman/GEFS/F048/WY_2016_GEFS_F048_noEnse.nc"
exampfilgefs = "/glade/scratch/wchapman/GEFS/F048/WY_2016_GEFS_F048_noEnse.nc"
...
NETCDF_IVTm_NAME = 'IVT_mean'
NETCDF_IVTs_NAME = 'IVT_std'
NETCDF_lat_NAME = 'lat'
NETCDF_lon_NAME = 'lon'
...
NETCDF_PREDICTOR_NAMES = [
    NETCDF_IVTm_NAME, NETCDF_IVTs_NAME, NETCDF_lat_NAME, NETCDF_lon_NAME
]

PREDICTOR_NAMES = [
    IVTmean, IVTstd, lats, lons
]
...
POST_NAME_KEY = IVTmean      #variable name of the post processed variable 
...
def count_samps(netcdf_file_names,targ_LATinds=None,targ_LONinds=None):

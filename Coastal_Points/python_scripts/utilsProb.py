...
#         print('targ_mat shape:',target_matrix.shape)
#         print('targ_LATinds shape:',targ_LATinds)
#         print('targ_LONinds shape:',targ_LONinds)
        target_matrix = numpy.reshape(target_matrix,(target_matrix.shape[0],-1))
#         print('mean target_matrix:',numpy.mean(target_matrix) )
#         print('log mean target_matrix:',numpy.mean(numpy.log(target_matrix)))
        
#         print(indPOST)
#         print(predictor_matrix.shape)
        post_matrix = copy.deepcopy(predictor_matrix[:,targ_LATinds,targ_LONinds,indPOST])
#         print('post_mat shape:',post_matrix.shape)
#         print('targ_LATinds shape:',targ_LATinds)
#         print('targ_LONinds shape:',targ_LONinds)
        post_matrix = numpy.reshape(post_matrix,(post_matrix.shape[0],-1))
#         print('mean post_matrix:',numpy.mean(post_matrix))
#         print('log mean post_matrix:',numpy.mean(numpy.log(post_matrix)))
...
#         print('target_mat mean:',numpy.mean(target_matrix))
        
    if indicesPOST:
        post_matrix = numpy.log(post_matrix)
#         print('post_mat mean:',numpy.mean(post_matrix))
...
def get_latlon_ind(latlonfolder):
    ...
    latind=numpy.array([])
    lonind=numpy.array([])
    allfolds = glob.glob('/glade/work/wchapman/AnEn/ThreshAna/lat*lon*')
